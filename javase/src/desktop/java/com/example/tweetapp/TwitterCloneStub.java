 ...
 * @author Shai Almog
 */
public class TwitterCloneStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "TwitterClone";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new TwitterCloneStub());
    }
